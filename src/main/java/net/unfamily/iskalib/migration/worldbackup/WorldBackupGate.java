...
public final class WorldBackupGate {
    ...
    // --- Server sync when the world is already running (imports client-side ack into SavedData) ---
    ...
    static boolean hasLegacyAckOnDisk(MinecraftServer server, WorldBackupGateConfig config) {
